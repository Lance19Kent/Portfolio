...
export const skillsData = [
  {
    ...
    description: "Aspiring full-stack developer with a strong focus on crafting responsive, user-centric front-end interfaces.",
    // Nilagay ko dito yung SVG para hindi kumalat sa component file
    icon: (
      <svg width="40" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M26.5 28.5L32.5 22.5L26.5 16.5" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M18.5 16.5L12.5 22.5L18.5 28.5" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <defs>
  ...
  },
  {
    ...
    description: "Specialized in creating intuitive and visually engaging digital experiences. Proficient in translating complex system requirements into accessible prototypes using tools like Figma and Canva.",
    icon: (
      <svg width="40" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="45" height="45" rx="10" fill="url(#paint0_linear_33_12)"/>
          <path d="M21.0417 19.5833L25.4167 23.9583" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M14.4792 35.625C15.4887 35.625 16.4755 35.3257 17.3149 34.7648C18.1543 34.204 18.8085 33.4068 19.1948 32.4741C19.5811 31.5415 19.6822 30.5152 19.4853 29.5251C19.2883 28.535 18.8022 27.6255 18.0884 26.9117C17.3745 26.1978 16.4651 25.7117 15.4749 25.5148C14.4848 25.3178 13.4586 25.4189 12.5259 25.8052C11.5932 26.1915 10.7961 26.8458 10.2352 27.6851C9.67436 28.5245 9.37501 29.5113 9.37501 30.5209C9.37528 31.4915 9.00612 32.4258 8.34251 33.1342C8.13803 33.3382 7.99871 33.5982 7.94223 33.8815C7.88574 34.1647 7.91463 34.4583 8.02522 34.7251C8.13581 34.9919 8.32313 35.2199 8.56343 35.3801C8.80374 35.5403 9.0862 35.6255 9.37501 35.625H14.4792Z" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M19.5381 29.8369L36.1763 13.2017C36.7568 12.6211 37.083 11.8337 37.083 11.0127C37.083 10.1917 36.7568 9.4043 36.1763 8.82375C35.5957 8.2432 34.8083 7.91705 33.9873 7.91705C33.1663 7.91705 32.3789 8.2432 31.7983 8.82375L15.1602 25.4619" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <defs>
  ...
  },
  {
    ...
    description: "Skilled in enhancing web applications by seamlessly integrating artificial intelligence APIs and third-party services to optimize functionality and elevate the overall user experience.",
    icon: (
      <svg width="40" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="45" height="45" rx="10" fill="url(#paint0_linear_33_39)"/>
          <path d="M22.5 16.6667V10.8334H16.6667" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          ...
          <path d="M7.91669 25.4166H10.8334" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M34.1667 25.4166H37.0834" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M26.875 23.9584V26.875" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M18.125 23.9584V26.875" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <defs>
  ...
  },
  {
    ...
    description: "Effective communicator and public speaker with experience facilitating peer-to-peer technical events. Adept at breaking down complex programming foundations and logical concepts.",
    icon: (
      <svg width="40" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="45" height="45" rx="10" fill="url(#paint0_linear_33_48)"/>
          <path d="M34.4583 13.75L9.37497 21.0416L8.06247 17.5416C7.62497 15.9375 8.49997 14.3333 9.95831 13.8958L29.6458 8.06247C31.25 7.62497 32.8541 8.49997 33.2916 9.95831L34.4583 13.75Z" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M14.0417 12.7291L18.5625 18.4166" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M23.0833 9.95837L27.6041 15.7917" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M9.375 21.0416H35.625V32.7083C35.625 33.4818 35.3177 34.2237 34.7707 34.7707C34.2237 35.3177 33.4819 35.625 32.7083 35.625H12.2917C11.5181 35.625 10.7763 35.3177 10.2293 34.7707C9.68229 34.2237 9.375 33.4818 9.375 32.7083V21.0416Z" stroke="white" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"/>
          <defs>
