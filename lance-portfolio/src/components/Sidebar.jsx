    ...
    return(
        <nav className= "h-full bg-red-10 w-full max-w-60 bg-white rounded-[10px] p-4">
            <div className="w-full flex flex-col">
                ...
                <div>
                    <ul>
                        <li className="flex justify-center items-center gap-2.5 py-3 cursor-pointer text-black hover:text-[#3FA6F4] ease-in stroke-black transition duration-75 hover:stroke-[#3FA6F4] bg-white hover:bg-[#00000008]">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
