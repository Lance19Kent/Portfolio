...
function ProjectsContent(){
    ...
    if (isLoading) {
        ...
        <div className="w-full h-full lg:pr-3 px-3 lg:px-0 py-3 overflow-y-auto no-scrollbar overflow-hidden flex flex-col gap-3">
            <BentoCard title={"Featured"} icon={featuredIcon} className="w-full relative ">
                ...
                {[1, 2, 3].map((i) => (
                    <div key={i} className="w-full h-full flex flex-col bg-white dark:bg-zinc-900/50 rounded-[14px] border border-zinc-200 dark:border-zinc-800 transition-all duration-300 overflow-hidden cursor-pointer">
    ...
    return(
        <div className="w-full h-full lg:pr-3 px-3 lg:px-0 py-3 overflow-y-auto no-scrollbar overflow-hidden flex flex-col gap-3"> 
            ...
            <BentoCard title={"Featured"} icon={featuredIcon} className="w-full relative "> 
                <div key="feat-grid-m" className="animate-in fade-in duration-700 delay-150 fill-mode-backwards grid lg:grid-cols-3 grid-cols-1 gap-5">
