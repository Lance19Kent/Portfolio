                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <div className="flex flex-wrap gap-2">
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">REACT JS</p>
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">CSS3</p>
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">TAILWIND CSS</p>
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">NEXT JS</p>
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">HTML</p>
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">JAVASCRIPT</p>
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">SQL</p>
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">GIT</p>
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">ZUSTAND</p>
                                <p className="text-[#B9B9B9] text-[12px] w-fit px-2 border py-0.5 rounded-[5px] border-border">SUPABASE</p>
                            </div>
