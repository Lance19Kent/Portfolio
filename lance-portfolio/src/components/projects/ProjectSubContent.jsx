...
<path d="M22.5 23.75C20.8424 23.75 19.2527 23.0915 18.0806 21.9194C16.9085 20.7473 16.25 19.1576 16.25 17.5V27.5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M11.25 25H5C4.33696 25 3.70107 24.7366 3.23223 24.2678C2.76339 23.7989 2.5 23.163 2.5 22.5V6.25C2.5 5.58696 2.76339 4.95107 3.23223 4.48223C3.70107 4.01339 4.33696 3.75 5 3.75H9.875C10.2931 3.7459 10.7056 3.84673 11.0746 4.04327C11.4437 4.23981 11.7575 4.52578 11.9875 4.875L13 6.375C13.2276 6.72066 13.5375 7.0044 13.9019 7.20075C14.2662 7.39711 14.6736 7.49993 15.0875 7.5H25C25.663 7.5 26.2989 7.76339 26.7678 8.23223C27.2366 8.70107 27.5 9.33696 27.5 10V16.25" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16.25 17.5C17.6307 17.5 18.75 16.3807 18.75 15C18.75 13.6193 17.6307 12.5 16.25 12.5C14.8693 12.5 13.75 13.6193 13.75 15C13.75 16.3807 14.8693 17.5 16.25 17.5Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M25 26.25C26.3807 26.25 27.5 25.1307 27.5 23.75C27.5 22.3693 26.3807 21.25 25 21.25C23.6193 21.25 22.5 22.3693 22.5 23.75C22.5 25.1307 23.6193 26.25 25 26.25Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>;
...
function ProjectSubContent({className="", projectList =[] , showViewAll = false }){
                ...
                <BentoCard title={"Other Projects"} icon={projectIcon} className="w-full">
                    <div className="flex flex-col gap-4 w-full">
                        <div className={`flex flex-col w-full gap-3 ${className}`}>
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="lg:px-3 px-6 w-full rounded-[10px] py-4 flex border-[.50px] border-border flex-col">
    ...
    return(
        <div className="grid gap-3">
            <BentoCard title={"Other Projects"} icon={projectIcon} className="w-full">
            <div key="psc-opts" className="animate-in fade-in duration-700 delay-300 fill-mode-backwards flex flex-col gap-4 w-full">
        ...
        <ContactMe animKey="psc-btn" wrapperClass="animate-in fade-in duration-700 delay-500 fill-mode-backwards" />
        </div>
