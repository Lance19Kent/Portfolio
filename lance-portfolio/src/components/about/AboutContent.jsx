...
function AboutContent() {
                ...
                <BentoCard title={"Certificates"} icon={certificateIcon} >
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col w-full gap-5 lg:pr-2">
                            {[1, 2, 3, 4, 5].map((i) => (
                                <div key={i} className={`flex flex-col w-full ${i !== 5 ? 'border-b border-zinc-100 dark:border-zinc-800/80 pb-5' : ''}`}>
    ...
    return (
        <div className="overflow-y-auto py-3 w-full gap-3 flex flex-col no-scrollbar">
                ...
                <div className="w-full relative h-70 sm:h-75 lg:h-64">
                    ...
                    <div className="absolute bottom-5 left-5 right-5 lg:bottom-8 lg:left-8 lg:right-auto z-20 flex flex-col gap-3 lg:gap-4 max-w-2xl">
                        ...
                        <div className="flex lg:flex-row flex-col items-start gap-3 mt-1 lg:mt-2">
                            <Button className="w-full sm:w-auto cursor-pointer rounded-[10px] bg-white text-zinc-900 hover:bg-zinc-200 shadow-sm transition-all duration-200 px-6 lg:px-8 py-5 lg:py-4 font-medium text-[14px] flex justify-center" asChild>
            ...
            <BentoCard title={"About"} icon={aboutIcon} className="leading-5">
                <div key="about-txt-m" className="animate-in fade-in duration-700 delay-250 fill-mode-backwards">
            ...
            <BentoCard title={"Highlights"} icon={highlightsIcon} className=" relative">
                ...
                <div className="animate-in fade-in duration-700 delay-150 fill-mode-backwards flex gap-3 overflow-x-auto no-scrollbar w-full justify-between" ref={highlightsRef} onScroll={() => handleScroll(highlightsRef, setcanHighlightsLeft, setcanHighlightsRight)}>
