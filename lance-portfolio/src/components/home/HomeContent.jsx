...
function Content() {
    ...
    return (
        <div className="w-full flex flex-col gap-3 lg:p-0 p-3 lg:overflow-y-auto lg:no-scrollbar lg:py-3 select-none">
            <div key="hero-m" className="animate-in fade-in duration-700 delay-150 fill-mode-backwards w-full flex flex-col overflow-hidden bg-card rounded-[10px] relative shrink-0">
                ...
                */}
                        ...
                        <div className="absolute bottom-5 left-5 right-5 lg:bottom-8 lg:left-8 lg:right-auto z-20 flex flex-col gap-3 lg:gap-4 max-w-lg">
                            ...
                            <div className="flex lg:flex-row flex-col items-start gap-3 mt-1 lg:mt-2">
                                ...
                                <button className="w-full sm:w-auto cursor-pointer rounded-[10px] bg-white text-zinc-900 hover:bg-zinc-200 transition-all duration-200 px-6 py-3 lg:py-2 lg:px-4 font-medium text-[14px] flex justify-center" asChild>
            ...
            <BentoCard title={"Stats"} icon={statsIcon} >
                <div key="stats-m" className="animate-in fade-in duration-700 delay-300 fill-mode-backwards grid lg:grid-cols-4 gap-3 grid-cols-2">
            ...
            <BentoCard icon={highlightsIcon} title={"Highlights"} className="relative">
                ...
                <div key="highlights-m" className="animate-in fade-in duration-700 delay-500 fill-mode-backwards flex  w-full gap-3 overflow-x-auto no-scrollbar" ref={highlightsRef} onScroll={() => handleScroll(highlightsRef, setcanHighlightsLeft, setcanHighlightsRight)}>
